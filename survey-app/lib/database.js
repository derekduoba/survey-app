...
module.exports = (function() {
  ...
  return {
     ...
     *  The array will be empty if no questions are found
    ...
    getQuestion: function(request, callback) {
      if (typeof request.qid === 'undefined' && typeof request.random === 'undefined' ) { // all questions
      ...
      } else if (typeof request.qid === 'undefined' && typeof request.random !== 'undefined' && Array.isArray(request.random)) { // random question
      ...
      } else if (typeof request.qid !== 'undefined' && !isNaN(request.qid)) { // specific question
        db.questions.find({ 
        ...
        if (record) {
          record.increment('responses').then(function() {
            db.questions.find({
              ...
              record.increment('total_responses').then(function() { 
                callback(true);
              });
            });
          });
